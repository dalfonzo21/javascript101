...
for(let i = 0; i < frameworks.length; i++) {
    const framework = frameworks[i].split("|");
    const frameworkName = framework[0];
    const releaseDate = framework[1];
    const usersName = framework[2];
    const popularityPercentage = framework[3];
