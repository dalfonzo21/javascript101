...
const pageId = "title";
// se supone que pageId no puede cambiar, por lo que se declara como constante.
// en pageTittle se establece const, ya que no cambia durante la ejecución de los scripts.
